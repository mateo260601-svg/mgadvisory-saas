...
def _build_summary_financials_annual(ws, styles: dict) -> None:
    ...
    bs_map = {
        127: ("Fixed Assets", 0), 128: ("[Placeholder] Intangible Assets", 0), 129: ("[Placeholder] Loans Receivable", 0), 130: ("[Placeholder] Investments in Subsidiaries", 0),
        131: ("Total non-current assets", 0), 134: ("Cash & cash equivalents", 23), 135: ("Trade & other inventory", 0),
        136: ("[Placeholder] Raw Materials", 0), 137: ("[Placeholder] Packing Materials", 0), 138: ("[Placeholder] Semi Finished Goods", 0), 139: ("[Placeholder] Finished Goods", 0),
        140: ("[Placeholder] Goods in Transit", 0), 141: ("[Placeholder] By Product", 0), 142: ("[Placeholder] Spares, Consumables and Others", 0),
        144: ("Trade & other receivables", 0), 145: ("Gross Receivables", 0), 146: ("Advances from Customers", 0),
        147: ("[Placeholder] Other Receivables", 0), 148: ("[Placeholder] Prepayments", 0), 150: ("[Placeholder] Due from related parties", 0),
        151: ("[Placeholder] Due from related parties - trade", 0), 152: ("[Placeholder] Due from related parties - non-trade", 0),
        153: ("Total current assets", 0), 155: ("Total Assets", 0), 161: ("Loans Payable", 24), 162: ("[Placeholder] Accrued Interest", 0),
        163: ("[Placeholder] Government Grant", 0), 164: ("[Placeholder] Deferred Taxes", 0), 165: ("Total non-current liabilities", 0),
        168: ("Trade & other payables", 0), 169: ("Gross Payables", 0), 170: ("Advances to Suppliers", 0),
        171: ("[Placeholder] Employee and Salary Provisions", 0), 172: ("[Placeholder] Other Payables", 0), 174: ("[Placeholder] Due to related parties", 0),
        175: ("[Placeholder] Due to related parties - trade", 0), 176: ("[Placeholder] Due to related parties - non-trade", 0),
    ...
    cfs_rows = {
        191: ("Net Income", 17), 192: ("[Placeholder] Prior period equity adjustment", 0), 193: ("Add: Interest Expense", 14),
        194: ("Add: Depreciation (D&A)", 12), 195: ("[Placeholder] Add: Other income / (loss)", 0), 196: ("[Placeholder] Add: Exchange gain / (loss)", 0),
        197: ("Add: Corporate tax", 16), 198: ("EBITDA (incl.restructuring fees)", 11), 200: ("Change in NWC", None),
        201: ("Change in trade working capital", 18), 202: ("Trade - Inventory", None), 203: ("[Placeholder] Raw Materials", 0),
        204: ("[Placeholder] Packing Materials", 0), 205: ("[Placeholder] Semi Finished Goods", 0), 206: ("[Placeholder] Finished Goods", 0), 207: ("[Placeholder] Goods in Transit", 0),
        208: ("Trade - Account Receivables", None), 209: ("Gross Receivables", 0), 210: ("[Placeholder] Advances from Customers", 0),
        211: ("[Placeholder] Due from Related Parties - Trade", 0), 212: ("Trade - Account Payables", None), 213: ("Gross Payables", 0),
        214: ("[Placeholder] Advances to Suppliers", 0), 215: ("[Placeholder] Due to related parties - Trade", 0), 217: ("[Placeholder] Change in non-trade working capital", 0),
        218: ("Non-Trade - Other Inventory", None), 219: ("[Placeholder] By Product", 0), 220: ("[Placeholder] Spares, Consumables and Others", 0),
        221: ("Non-Trade - Other Account Receivables", None), 222: ("[Placeholder] Other Receivables", 0), 223: ("[Placeholder] Prepayments", 0),
        224: ("[Placeholder] Due from Related Parties - Non Trade", 0), 225: ("Non-Trade - Other Account Payables", None),
        226: ("[Placeholder] Employee and Salary Provisions", 0), 227: ("[Placeholder] Other Payables", 0), 228: ("[Placeholder] Due to related parties - Non trade", 0),
        229: ("Cash flow from Operations", 20), 231: ("Sale/ (Purchase) of fixed assets", 19), 232: ("[Placeholder] Loan Receivable", 0),
        233: ("[Placeholder] Investments in Subsidiaries", 0), 234: ("[Placeholder] Change in intangible assets", 0), 235: ("Cash flow from Investing activities", 19),
        237: ("Interest Paid", 14), 238: ("Loan Repayment", 21), 239: ("[Placeholder] Government Grant", 0), 240: ("Cash flow from Financing activities", 21),
